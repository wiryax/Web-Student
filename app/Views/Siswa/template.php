...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-3">
                <ul class="list-group">
                    <li class="list-group-item"><a href="/Siswa/Jadwal">jadwal</a></li>
                    <li class="list-group-item"><a href="/Siswa/Nilai">Nilai</a></li>
                    <li class="list-group-item"><a href="/Siswa/Tugas">Tugas</a></li>
